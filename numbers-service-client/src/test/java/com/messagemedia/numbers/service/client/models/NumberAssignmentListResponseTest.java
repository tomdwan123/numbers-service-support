...
import static com.messagemedia.numbers.service.client.models.TestData.randomNumberAssignmentListResponse;

public class NumberAssignmentListResponseTest {

    @Test
    public void testAccessors() throws Exception {
        assertGettersAndSetters(randomNumberAssignmentListResponse());
    }

    @Test
    public void testToString() {
        assertToString(randomNumberAssignmentListResponse());
    }
}
