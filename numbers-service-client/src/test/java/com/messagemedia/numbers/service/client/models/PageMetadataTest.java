...
import static com.messagemedia.numbers.service.client.models.TestData.randomPageMetadataDto;

public class PageMetadataTest {

    @Test
    public void testAccessors() throws Exception {
        assertGettersAndSetters(randomPageMetadataDto());
    }

    @Test
    public void testToString() {
        assertToString(randomPageMetadataDto());
    }
}